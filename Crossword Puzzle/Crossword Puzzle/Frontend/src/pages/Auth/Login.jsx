      ...
      <div className="w-full max-w-md mx-auto space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-base text-gray-600 dark:text-gray-400">
            Sign in to your account to continue creating amazing crosswords
          </p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full rounded-lg border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 py-2.5 pl-10 pr-4 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition"
